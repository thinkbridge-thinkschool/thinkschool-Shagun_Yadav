...
public interface IParkingSpotRepository
{
    ...
    /// <summary>Day 32: powers the frontend's spot picker/status grid.</summary>
    Task<IReadOnlyList<Domain>> GetByFacilityIdAsync(Guid facilityId, CancellationToken cancellationToken = default);
