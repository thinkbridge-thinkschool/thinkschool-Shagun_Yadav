...
public interface IReservationRepository
{
    ...
    /// <summary>Day 32: powers the frontend's "my reservations" view.</summary>
    Task<IReadOnlyList<Domain>> GetByUserIdAsync(Guid userId, CancellationToken cancellationToken = default);
